...
const WorkspacePage = async () => {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col overflow-hidden px-6 pb-12 pt-6 md:px-10 md:pt-8">
      ...
      <div className="mx-auto w-full max-w-6xl justify-between flex flex-col gap-8">
        {/* Workspace Header */}
        ...
        <section className="space-y-5">
          {workspaceLoadError && (
            <div className="rounded-xl border border-destructive/40 bg-destructive/10 px-4 py-3 text-sm text-destructive">
              We could not load your workspaces right now. Please try again in a moment.
            </div>
          )}

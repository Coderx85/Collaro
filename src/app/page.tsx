...
const Rootpage = async () => {
  ...
  return (
    <>
      ...
      <section
        className='relative mx-auto flex flex-col bg-gradient-to-br dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 from-gray-100 via-white to-gray-100 items-center justify-center overflow-y-auto scroll-smooth'
      ...
      >
        ...
        {/* Hero Section */}
        <div
          className='px-4 py-6 md:py-28 min-h-screen w-full flex flex-col items-center '
        ...
        >
          ...
          <div className='flex justify-center mt-5 gap-5'>
            ...
            <Link href='/guide'>
              <Button
                className='rounded-lg font-bold border-2 dark:bg-transparent bg-white/80 border-primary hover:bg-primary/10 text-primary shadow-md'
                variant={"outline"}
              >
                User Guide
              </Button>
          ...
          <p className='mt-4 max-w-4xl mx-auto text-center xl:text-lg text-sm text-slate-600 dark:text-gray-400'>
            Join us to connect with developers, share ideas, and collaborate on
            projects.
          </p>
        </div>

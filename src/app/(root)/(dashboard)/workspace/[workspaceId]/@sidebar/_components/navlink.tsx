      ...
      {sidebarLinks.map((item: SidebarLink, index: number) => {
        ...
        return shouldRender ? (
          <Link
            ...
            key={index}
            className={cn(
              "flex w-full group items-end p-2.5 rounded-sm cursor-pointer justify-start hover:bg-linear-to-br from-white/50 via-white to-white/80 hover:text-dark-2 ease-in duration-100 hover:animate-out",
              {
                ...
                "bg-linear-to-br from-white/50 via-white to-white/80 text-dark-2 hover:animate-none":
                  isActive,

...
export default function SignInPage() {
  return (
    <div className="flex items-center justify-center px-4 sm:px-6 xl:px-8 py-4 sm:py-6 xl:py-8 min-h-screen bg-gradient-to-br from-slate-300 dark:from-slate-950 to-slate-700">
      <SignIn.Root>
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start" className="w-full sm:max-w-md">
                <Card className="w-full bg-gradient-to-br from-slate-500/85 border-gray-100 border-2 to-slate-500/85 dark:from-slate-950/50 dark:to-slate-950/50">
                  ...
                  <CardContent className="grid gap-y-3 sm:gap-y-4">
                    <div className="grid gap-x-4 gap-3">

...
const FeatureBox = ({
  ...
  return (
    <div
      ...
      <p
        className="text-sm items-start text-start text-slate-600 dark:text-slate-400 group-hover/feature:text-slate-700 dark:group-hover/feature:text-slate-200 max-w-xs z-10 px-10">
        {description}
      </p>
    </div>
  );
